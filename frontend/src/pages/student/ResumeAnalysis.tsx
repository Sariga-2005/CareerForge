              ...
              <div className="md:col-span-3 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {roleMatchResult.matchedSkills?.length > 0 ? roleMatchResult.matchedSkills.map((skill: string) => (
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {roleMatchResult.missingSkills?.length > 0 ? roleMatchResult.missingSkills.map((skill: string) => (
            ...
            {roleMatchResult.recommendations?.length > 0 && (
              <div className="mt-4 bg-accent/10 border border-accent/20 rounded-lg p-4">
                ...
                <ul className="space-y-1">
                  {roleMatchResult.recommendations.map((rec: string, i: number) => (
