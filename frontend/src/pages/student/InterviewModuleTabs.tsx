...
const InterviewModuleTabs: React.FC = () => {
    ...
    return (
        <div className="flex items-center gap-1 p-1.5 bg-surface-200 rounded-2xl border-2 border-surface-300 mb-6 overflow-x-auto overflow-y-hidden">
            {TABS.map((tab) => {
                ...
                return (
                    <button
                        ...
                        className={`relative flex items-center gap-1.5 px-4 py-2.5 rounded-xl text-xs font-semibold transition-all duration-200 flex-1 justify-center whitespace-nowrap overflow-hidden
              ${isActive
                                ? 'text-white'
